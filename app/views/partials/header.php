...
<div class="top-bar">
    <div class="container top-bar-content">
        <div class="top-contact">
            ...
            <a href="mailto:info@ankammathallitemple.org" aria-label="Email Us">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/>
                </svg>
                <span>info@ankammathallitemple.org</span>
            </a>
        </div>
        <div class="top-social">
            <span class="online-status">● TEMPLE OPEN</span>
            <a href="https://www.facebook.com/ankammathalli/" target="_blank" aria-label="Facebook">
